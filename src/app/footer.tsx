              ...
              >
                ...
                {item.type === 'video' && (
                  <div className="absolute inset-0 flex items-center justify-center z-20 opacity-0 group-hover:opacity-100 transition-all duration-300">
                    <button 
                      className="w-16 h-16 bg-[#FFB800] rounded-full flex items-center justify-center transform scale-0 group-hover:scale-100 transition-transform duration-300 shadow-2xl"
                      onClick={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                        handleVideoPlayPause(index, item);
                      }}
                    >
                ...
                <div className="absolute top-4 right-4 z-30">
                  <div className="flex flex-col items-end gap-2">
                    <span className="bg-black/80 backdrop-blur-sm text-[#FFB800] px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">
                      {categories.find(c => c.id === item.category)?.name}
                    </span>
                    {item.type === 'video' && (
                      <span className="bg-[#FFB800] text-black px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider flex items-center gap-1">
                ...
                <div className="absolute bottom-4 left-4 z-30 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  <h3 className="text-white font-semibold text-sm bg-black/60 backdrop-blur-sm px-3 py-2 rounded-lg">
                    {item.title}
                  </h3>
                </div>
                ...
                <div className="absolute top-4 left-4 z-30 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  <button className="w-10 h-10 bg-black/60 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-[#FFB800] transition-all duration-300 group/save">
                    <svg 
                      className="w-5 h-5 text-white group-hover/save:text-black transition-colors" 
                      fill="none" 
                      stroke="currentColor" 
                      viewBox="0 0 24 24"
                    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="group relative h-[600px] rounded-2xl overflow-hidden cursor-pointer bg-gray-800">
              ...
              <div className="absolute top-6 right-6 z-30">
                <span className="bg-black/80 backdrop-blur-sm text-[#FFB800] px-4 py-2 rounded-full text-sm font-bold uppercase tracking-wider">
                  Wedding Performance
                </span>
              </div>
              <div className="absolute bottom-6 left-6 z-30">
                <h3 className="text-white text-2xl font-bold bg-black/60 backdrop-blur-sm px-4 py-2 rounded-lg">
                  Featured Wedding Performance
                </h3>
              </div>
            </div>
